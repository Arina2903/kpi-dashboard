...
class LoginController extends Controller
{
    ...
    public function login(
        ...
        if(empty($employees)){
            ...
            return back()->with(
                'error',
                'Email tidak dijumpai atau akaun tidak aktif.'
            );
        }
    ...
    private function setEmployeeSession(
        array $employee
    ): void {
