...
@php
    ...
    $categoryStyles = [
        ...
        'Default'           => ['bg'=>'bg-slate-700 text-white',  'sub'=>'bg-slate-50 text-slate-800 border border-[#6B9080]/40',    'left'=>'border-l-slate-300'],
    ];
...
<div class="grid grid-cols-1 xl:grid-cols-5 gap-3">
    ...
    <div class="{{ $isManager ? 'xl:col-span-3' : 'xl:col-span-5' }} bg-white rounded-2xl p-4 soft-card border border-[#6B9080]/30">
    ...
    <div class="xl:col-span-2 flex flex-col gap-3">
        ...
        {{-- My Department donut --}}
        <div class="bg-white rounded-2xl p-3 soft-card border border-[#6B9080]/30 flex items-center gap-3">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="bg-white rounded-xl p-3 soft-card border border-[#6B9080]/30">
            ...
            <div class="bg-white rounded-xl p-3 soft-card border border-[#6B9080]/30">
                ...
                @endforeach
                <div class="mt-1.5 pt-1.5 border-t border-[#6B9080]/30 flex items-center justify-between">
...
@if($isManager && $deptRows->count() > 0)
    ...
    {{-- Quarterly trend --}}
    <div class="bg-white rounded-2xl p-4 soft-card border border-[#6B9080]/30">
    ...
    <div class="space-y-2">
        ...
        @foreach($deptRows as $dept)
            ...
            <div class="bg-white rounded-2xl border border-[#6B9080]/30 overflow-hidden soft-card">
                ...
                <div id="dept-body-{{ $safeCode }}" class="dept-body closed border-t border-[#6B9080]/30">
                    <div class="p-4">
                        ...
                        <div>
                            <div class="overflow-x-auto thin-scroll">
                                <table class="w-full min-w-[540px]">
                                    <thead>
                                        <tr class="bg-slate-50 text-[9px] uppercase tracking-wider text-slate-500 font-black border-b border-[#6B9080]/30">
...
<div class="bg-white rounded-2xl border border-[#6B9080]/30 soft-card overflow-hidden">
    ...
    @if($canAssignTarget)
    <div id="assignLinkageForm" class="hidden border-b border-[#6B9080]/30 bg-slate-50 px-4 py-3">
        <form action="{{ route('linkage.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 items-end">
                <div>
                    ...
                    <select name="assignee_id" required class="w-full rounded-xl border border-[#6B9080]/40 bg-white px-2 py-2 text-xs font-bold text-slate-700 focus:border-[#6B9080] focus:outline-none">
                ...
                <div>
                    ...
                    <select id="lnkCategory" name="category" required onchange="updateLnkSubCat()"
                            class="w-full rounded-xl border border-[#6B9080]/40 bg-white px-2 py-2 text-xs font-bold text-slate-700 focus:border-[#6B9080] focus:outline-none">
                ...
                <div>
                    ...
                    <select name="unit" required class="w-full rounded-xl border border-[#6B9080]/40 bg-white px-2 py-2 text-xs font-bold text-slate-700 focus:border-[#6B9080] focus:outline-none">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="p-2.5 rounded-xl border {{ $lnkMet ? 'border-emerald-200 bg-emerald-50' : 'border-amber-200 bg-amber-50' }}">
                        ...
                        <div class="flex items-center gap-2 mb-1.5">
                            <div class="flex-1 h-1.5 bg-white/80 rounded-full overflow-hidden border border-[#6B9080]/40">
            ...
            <div>
                ...
                <div class="space-y-2">
                    ...
                    @php $lnkMet = $lnk['met']; @endphp
                    <div class="p-2.5 rounded-xl border border-[#6B9080]/40 bg-slate-50 group">
                        <div class="flex items-center justify-between mb-1.5">
                            <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2 mb-1.5">
                            <div class="flex-1 h-1.5 bg-white rounded-full overflow-hidden border border-[#6B9080]/40">
...
<div class="pt-1 border-t border-[#6B9080]/40">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-3">
        ...
        {{-- Quick stats --}}
        @if($individualKpiCount === 0)
        <div class="lg:col-span-3 flex items-center justify-center bg-white rounded-2xl border border-dashed border-[#6B9080]/40 p-8 soft-card">
            <div class="text-center">
        ...
        <div class="lg:col-span-3 grid grid-cols-2 sm:grid-cols-4 gap-3 content-start">
            <div class="bg-white rounded-xl border border-[#6B9080]/40 p-3 soft-card">
            ...
            <div class="bg-white rounded-xl border {{ $myAtRisk > 0 ? 'border-red-100' : 'border-[#6B9080]/40' }} p-3 soft-card">
            ...
            <div class="bg-white rounded-xl border border-[#6B9080]/30 p-3 soft-card">
                <p class="text-[9px] uppercase font-black text-[#A07060] mb-1.5">Completed Quarters</p>
                @foreach(['Q1','Q2','Q3','Q4'] as $qi)
    ...
    <div class="mt-4">
        @if($orderedCategoryGroups->isEmpty())
            <div class="bg-white rounded-2xl border border-dashed border-[#6B9080]/50 p-8 text-center">
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-3 gap-2">
                            @foreach($categoryKpis as $kpi)
                                ...
                                <div onclick="openKpiDetail('{{ $kpi['id'] }}')"
                                     class="bg-white rounded-xl border border-l-4 border-[#6B9080]/40 {{ $lb }} p-3 cursor-pointer hover:shadow-md transition-shadow soft-card group">
...
@foreach($kpis ?? [] as $kpi)
    @php
        ...
        $mc = ['Financial'=>['bg-emerald-700 text-white',['bg-emerald-50 text-emerald-800 border border-emerald-200']],'Growth & Customer'=>['bg-indigo-700 text-white',['bg-indigo-50 text-indigo-800 border border-indigo-200']],'Initiatives'=>['bg-amber-600 text-white',['bg-amber-50 text-amber-800 border border-amber-200']],'People'=>['bg-pink-700 text-white',['bg-pink-50 text-pink-800 border border-pink-200']],'Default'=>['bg-slate-700 text-white',['bg-slate-50 text-slate-800 border border-[#6B9080]/40']]];
    ...
    <div id="kpi-modal-{{ $kpi['id'] }}" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-950/50 px-4" onclick="closeKpiDetail('{{ $kpi['id'] }}')">
        <div class="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-[#6B9080]/40 overflow-hidden" onclick="event.stopPropagation()">
            ...
            <div class="p-4 space-y-4 max-h-[70vh] overflow-y-auto thin-scroll">
                <div class="grid grid-cols-3 gap-2">
                    <div class="rounded-xl bg-slate-50 border border-[#6B9080]/40 p-2"><p class="text-[9px] text-slate-400 uppercase">Base Target</p><p class="text-xs font-black text-slate-900">{{ $mFmt($mBase) }}</p></div>
                    <div class="rounded-xl bg-slate-50 border border-[#6B9080]/40 p-2"><p class="text-[9px] text-slate-400 uppercase">Stretch</p><p class="text-xs font-black text-slate-900">{{ $mFmt(max(0,(float)($kpi['stretch_target']??0))) }}</p></div>
                    <div class="rounded-xl bg-[#FBF5EF] border border-[#6B9080]/30 p-2"><p class="text-[9px] text-[#A07060] uppercase">Actual</p><p class="text-xs font-black text-[#4a2a1a]">{{ $mFmt($mActual) }}</p></div>
                </div>
                <div class="rounded-xl border border-[#6B9080]/40 p-3">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="rounded-xl border border-[#6B9080]/40 p-3"><p class="text-[10px] text-slate-400 uppercase mb-1">Category</p><span class="inline-block px-2 py-1 rounded-lg text-[10px] font-bold {{ $mCatClass }}">{{ $kpi['category']??'-' }}</span></div>
                    <div class="rounded-xl border border-[#6B9080]/40 p-3"><p class="text-[10px] text-slate-400 uppercase mb-1">Sub Category</p><span class="inline-block px-2 py-1 rounded-lg text-[10px] font-semibold {{ $mSubClass }}">{{ $kpi['sub_category']??'-' }}</span></div>
                </div>
                <div class="rounded-xl bg-slate-50 border border-[#6B9080]/40 p-3"><p class="text-[10px] text-slate-400 uppercase mb-1">Description</p><p class="text-xs text-slate-700 leading-relaxed">{{ $kpi['kpi_description']??'No description.' }}</p></div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="rounded-xl bg-white border border-[#6B9080]/30 p-3"><p class="text-[10px] text-slate-400 uppercase">Unit</p><p class="font-bold text-slate-800 mt-1 text-xs">{{ $mUnitLabel }}</p></div>
                    @php
                        ...
                        $ciDate = $ciRaw
                            ...
                            : '-';
                    @endphp
                    <div class="rounded-xl bg-slate-50 border border-[#6B9080]/40 p-3"><p class="text-[10px] text-slate-400 uppercase">Last Check-In</p><p class="font-bold text-slate-800 mt-1 text-[11px]">{{ $ciDate }}</p></div>
                </div>
            </div>
            <div class="px-4 py-3 bg-slate-50 border-t border-[#6B9080]/40 flex justify-end gap-2">
                <button type="button" onclick="closeKpiDetail('{{ $kpi['id'] }}')" class="px-3 py-2 rounded-lg bg-white border border-[#6B9080]/40 text-slate-700 text-xs font-bold hover:bg-slate-100">Close</button>
