...
<div class="p-6 space-y-5">
    ...
    {{-- HEADER --}}
    <div class="rounded-[20px] bg-gradient-to-r from-[#9D5268] to-[#E97C7F] text-white p-7 shadow-xl">
            ...
            <button onclick="toggleStaff('{{ $staffSlug }}')"
                ...
                <div class="flex flex-col xl:flex-row xl:items-center gap-4">
                    ...
                    <div class="flex items-center gap-4 flex-1 min-w-0">
                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#9D5268] to-[#E97C7F] flex items-center justify-center text-white font-black text-lg shrink-0 group-hover:scale-105 transition">
                            {{ $initials ?: '?' }}
                        </div>
