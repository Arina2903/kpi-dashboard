                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="password"
                                id="passwordInput"
                                class="w-full rounded-xl border border-slate-200 pl-4 pr-11 py-3 text-sm bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] focus:outline-none transition"
                            ...
                            <button
                                ...
                                class="absolute right-0 top-0 h-full px-3.5 flex items-center text-slate-400 hover:text-[#7A0019] transition"
                                aria-label="Show password"
                            >
                                <svg id="eyeOpen" class="w-4.5 h-4.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                                </svg>
                                <svg id="eyeClosed" class="w-4.5 h-4.5 hidden" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
