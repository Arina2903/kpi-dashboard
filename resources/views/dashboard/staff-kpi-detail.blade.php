...
<div class="px-4 pt-4 pb-10">
    ...
    {{-- Breadcrumb / back --}}
    <a href="{{ $backUrl ?? route('dashboard.staff.kpis', $staff['id']) }}" class="inline-flex items-center gap-1.5 text-[11px] font-bold text-slate-400 hover:text-[#E97C7F] transition mb-3">
